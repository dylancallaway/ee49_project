...
def train(create_tensor_dict_fn,
  ...
  with tf.Graph().as_default():
    ...
    '''
    Added these lines to try to stop this error:
    "Allocator ran out of memory trying to allocate X MB..."
    Did not work entirely, but the model trains and they are useful to have for configuration.
